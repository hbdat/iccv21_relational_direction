# -*- coding: utf-8 -*-
"""
Created on Tue Aug 18 10:50:46 2020
...
replace_word = [('','')]
#%%
path = './data/Visual_Genome/VG_list_hoi.csv'
...
#%%
df.to_csv("./data/Visual_Genome/aug_VG_list_hoi.csv",index=None)
#%% pre-processing
...
with open('./w2v/VG_act_obj.pkl','wb') as f:
